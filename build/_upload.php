<?php
	...
	$uploads_dir = 'elements/bundles/images';//specify the upload folder, make sure it's writable!
	$relative_path = '../bundles/images';//specify the relative path from your elements to the upload folder
